...
function Header(props) {
	return (
		<div className="header">
			<Link className="header__title-link" to="/"><h2 className="header__title">ITMO.<span className="header__title-accent">Coins</span></h2></Link>
			<div className="header__info">
				<div className="header__person">
					<h2 className="header__person-name">{props.name}</h2>
					<h2 className="header__person-group">{props.isu}</h2>
				</div>
				<Link to="/profile"><img src={avatar} className="header__avatar" alt="аватар" /></Link>
